...
INSERT INTO public.settings (key, value, description) VALUES
  ...
  ('about_intro_text1',   'Somos un servicio técnico especializado en la <strong>reparación de televisores en Getafe (Madrid)</strong>, con una sólida trayectoria ofreciendo soluciones eficaces para todo tipo de averías.', 'Primer párrafo de ¿Quiénes Somos?'),
  ...
  ('about_location_text', 'Ofrecemos cobertura en <strong>Getafe y municipios cercanos</strong>.', 'Texto de la sección localización'),
